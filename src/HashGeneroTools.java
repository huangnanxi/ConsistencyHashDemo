...
public class HashGeneroTools {
    ...
    public HashGeneroTools(List<NodeDefine> shards) {
        super();
        this.shards = shards;
        init();
    }
    ...
    public static void main(String[] args) {
        NodeDefine nodeDefine1 = new NodeDefine("node1");
        NodeDefine nodeDefine2 = new NodeDefine("node2");
        NodeDefine nodeDefine3 = new NodeDefine("node3");
        NodeDefine nodeDefine4 = new NodeDefine("node4");
        
        List<NodeDefine> shards = new ArrayList<>();
        shards.add(nodeDefine1);
        shards.add(nodeDefine2);
        shards.add(nodeDefine3);
        shards.add(nodeDefine4);
        
        HashGeneroTools hashGeneroTools = new HashGeneroTools(shards);
